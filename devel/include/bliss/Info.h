// Generated by gencpp from file bliss/Info.msg
// DO NOT EDIT!


#ifndef BLISS_MESSAGE_INFO_H
#define BLISS_MESSAGE_INFO_H
...
struct Info_
{
  ...
  _currentGoalId_type currentGoalId;
   ...
   typedef  ::bliss::MapGraph_<ContainerAllocator>  _odom_cache_type;
  ...
  typedef boost::shared_ptr< ::bliss::Info_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::bliss::Info_<ContainerAllocator> const> ConstPtr;

}; // struct Info_

typedef ::bliss::Info_<std::allocator<void> > Info;

typedef boost::shared_ptr< ::bliss::Info > InfoPtr;
typedef boost::shared_ptr< ::bliss::Info const> InfoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::bliss::Info_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::bliss::Info_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::bliss::Info_<ContainerAllocator1> & lhs, const ::bliss::Info_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::bliss::Info_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::bliss::Info_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::bliss::Info_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::bliss::Info_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::bliss::Info_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::bliss::Info_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::bliss::Info_<ContainerAllocator> >
{
  ...
  static const char* value(const ::bliss::Info_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x656fb5b8dfd8dfd2ULL;
  static const uint64_t static_value2 = 0xdc40226f35f2d440ULL;
};

template<class ContainerAllocator>
struct DataType< ::bliss::Info_<ContainerAllocator> >
{
  static const char* value()
  {
    return "bliss/Info";
...
template<class ContainerAllocator>
struct Definition< ::bliss::Info_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::bliss::Info_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::bliss::Info_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::bliss::Info_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "odom_cache: ";
    s << std::endl;
    Printer< ::bliss::MapGraph_<ContainerAllocator> >::stream(s, indent + "  ", v.odom_cache);
  }
};
