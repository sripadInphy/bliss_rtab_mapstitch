...
"""autogenerated by genpy from bliss/NodeData.msg. Do not edit."""
import codecs
import sys
...
float64 value"""
  ...
  _slot_types = ['int32','int32','int32','float64','string','geometry_msgs/Pose','geometry_msgs/Pose','bliss/GPS','uint8[]','uint8[]','float32[]','float32[]','float32[]','float32[]','float32[]','float32[]','float32[]','geometry_msgs/Transform[]','uint8[]','int32','float32','int32','geometry_msgs/Transform','uint8[]','uint8[]','uint8[]','uint8[]','float32','bliss/Point3f','int32[]','int32[]','bliss/KeyPoint[]','bliss/Point3f[]','uint8[]','bliss/GlobalDescriptor[]','bliss/EnvSensor[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.grid_view_point is None:
        self.grid_view_point = bliss.msg.Point3f()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.globalDescriptors = []
      for i in range(0, length):
        val1 = bliss.msg.GlobalDescriptor()
        _v11 = val1.header
        start = end
        end += 4
