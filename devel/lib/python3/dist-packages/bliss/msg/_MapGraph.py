...
"""autogenerated by genpy from bliss/MapGraph.msg. Do not edit."""
import codecs
import sys
...
float64[36] information"""
  ...
  _slot_types = ['std_msgs/Header','geometry_msgs/Transform','int32[]','geometry_msgs/Pose[]','bliss/Link[]']
