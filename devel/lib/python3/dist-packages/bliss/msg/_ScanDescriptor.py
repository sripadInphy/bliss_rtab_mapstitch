...
"""autogenerated by genpy from bliss/ScanDescriptor.msg. Do not edit."""
import codecs
import sys
...
uint8[] data"""
  ...
  _slot_types = ['std_msgs/Header','sensor_msgs/LaserScan','sensor_msgs/PointCloud2','bliss/GlobalDescriptor']
