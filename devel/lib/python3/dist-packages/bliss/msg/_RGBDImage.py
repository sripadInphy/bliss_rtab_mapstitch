...
"""autogenerated by genpy from bliss/RGBDImage.msg. Do not edit."""
import codecs
import sys
...
uint8[] data"""
  ...
  _slot_types = ['std_msgs/Header','sensor_msgs/CameraInfo','sensor_msgs/CameraInfo','sensor_msgs/Image','sensor_msgs/Image','sensor_msgs/CompressedImage','sensor_msgs/CompressedImage','bliss/KeyPoint[]','bliss/Point3f[]','uint8[]','bliss/GlobalDescriptor']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.global_descriptor is None:
        self.global_descriptor = bliss.msg.GlobalDescriptor()
    else:
      self.header = std_msgs.msg.Header()
      self.rgb_camera_info = sensor_msgs.msg.CameraInfo()
      self.depth_camera_info = sensor_msgs.msg.CameraInfo()
