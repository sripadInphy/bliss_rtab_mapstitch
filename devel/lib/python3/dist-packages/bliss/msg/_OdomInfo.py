...
"""autogenerated by genpy from bliss/OdomInfo.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','bool','int32','int32','float32','float32','float32','float32','float32','int32','float64[36]','int32','int32','int32','int32','int32','int32','float32','bool','float32','float32','float32','float32','float32','int32','float32','float32','int32[]','bliss/CameraModels[]','geometry_msgs/Pose[]','geometry_msgs/Transform','geometry_msgs/Transform','geometry_msgs/Transform','geometry_msgs/Transform','int32','int32[]','bliss/KeyPoint[]','int32[]','int32[]','int32[]','bliss/Point3f[]','sensor_msgs/PointCloud2','bliss/Point2f[]','bliss/Point2f[]','int32[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = bliss.msg.CameraModels()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.models = []
        for i in range(0, length):
          val2 = bliss.msg.CameraModel()
