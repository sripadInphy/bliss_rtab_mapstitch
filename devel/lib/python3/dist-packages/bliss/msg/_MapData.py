...
"""autogenerated by genpy from bliss/MapData.msg. Do not edit."""
import codecs
import sys
...
float64 value"""
  ...
  _slot_types = ['std_msgs/Header','bliss/MapGraph','bliss/NodeData[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          val2 = bliss.msg.GlobalDescriptor()
          _v43 = val2.header
          start = end
          end += 4
