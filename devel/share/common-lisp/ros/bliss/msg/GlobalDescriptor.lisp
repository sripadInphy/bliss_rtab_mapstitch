...
(cl:defmethod cl:initialize-instance :after ((m <GlobalDescriptor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GlobalDescriptor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bliss-msg:<GlobalDescriptor> is deprecated: use bliss-msg:GlobalDescriptor instead.")))
...
(cl:defmethod info-val ((m <GlobalDescriptor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bliss-msg:info-val is deprecated.  Use bliss-msg:info instead.")
  (info m))
