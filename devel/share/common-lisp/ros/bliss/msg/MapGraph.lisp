...
(cl:defclass <MapGraph> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (links
    :reader links
    :initarg :links
    :type (cl:vector bliss-msg:Link)
   :initform (cl:make-array 0 :element-type 'bliss-msg:Link :initial-element (cl:make-instance 'bliss-msg:Link))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MapGraph>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MapGraph)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bliss-msg:<MapGraph> is deprecated: use bliss-msg:MapGraph instead.")))
...
(cl:defmethod mapToOdom-val ((m <MapGraph>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bliss-msg:mapToOdom-val is deprecated.  Use bliss-msg:mapToOdom instead.")
  (mapToOdom m))

(cl:ensure-generic-function 'posesId-val :lambda-list '(m))
(cl:defmethod posesId-val ((m <MapGraph>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bliss-msg:posesId-val is deprecated.  Use bliss-msg:posesId instead.")
  (posesId m))

(cl:ensure-generic-function 'poses-val :lambda-list '(m))
(cl:defmethod poses-val ((m <MapGraph>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bliss-msg:poses-val is deprecated.  Use bliss-msg:poses instead.")
  (poses m))

(cl:ensure-generic-function 'links-val :lambda-list '(m))
(cl:defmethod links-val ((m <MapGraph>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bliss-msg:links-val is deprecated.  Use bliss-msg:links instead.")
  (links m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MapGraph>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'links)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'bliss-msg:Link))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
