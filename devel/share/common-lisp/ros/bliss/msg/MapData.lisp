...
(cl:defclass <MapData> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (graph
    :reader graph
    :initarg :graph
    :type bliss-msg:MapGraph
    :initform (cl:make-instance 'bliss-msg:MapGraph))
   (nodes
    :reader nodes
    :initarg :nodes
    :type (cl:vector bliss-msg:NodeData)
   :initform (cl:make-array 0 :element-type 'bliss-msg:NodeData :initial-element (cl:make-instance 'bliss-msg:NodeData))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MapData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MapData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bliss-msg:<MapData> is deprecated: use bliss-msg:MapData instead.")))
...
(cl:defmethod graph-val ((m <MapData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bliss-msg:graph-val is deprecated.  Use bliss-msg:graph instead.")
  (graph m))

(cl:ensure-generic-function 'nodes-val :lambda-list '(m))
(cl:defmethod nodes-val ((m <MapData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bliss-msg:nodes-val is deprecated.  Use bliss-msg:nodes instead.")
  (nodes m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MapData>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'nodes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'bliss-msg:NodeData))
