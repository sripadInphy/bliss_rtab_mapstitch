...
(cl:defmethod cl:initialize-instance :after ((m <Path>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Path)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bliss-msg:<Path> is deprecated: use bliss-msg:Path instead.")))
...
(cl:defmethod nodeIds-val ((m <Path>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bliss-msg:nodeIds-val is deprecated.  Use bliss-msg:nodeIds instead.")
  (nodeIds m))
