...
(cl:defmethod cl:initialize-instance :after ((m <UserData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UserData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bliss-msg:<UserData> is deprecated: use bliss-msg:UserData instead.")))
...
(cl:defmethod rows-val ((m <UserData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bliss-msg:rows-val is deprecated.  Use bliss-msg:rows instead.")
  (rows m))

(cl:ensure-generic-function 'cols-val :lambda-list '(m))
(cl:defmethod cols-val ((m <UserData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bliss-msg:cols-val is deprecated.  Use bliss-msg:cols instead.")
  (cols m))
...
(cl:defmethod data-val ((m <UserData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bliss-msg:data-val is deprecated.  Use bliss-msg:data instead.")
  (data m))
