...
(cl:defmethod cl:initialize-instance :after ((m <ScanDescriptor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ScanDescriptor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bliss-msg:<ScanDescriptor> is deprecated: use bliss-msg:ScanDescriptor instead.")))
...
(cl:defmethod scan-val ((m <ScanDescriptor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bliss-msg:scan-val is deprecated.  Use bliss-msg:scan instead.")
  (scan m))

(cl:ensure-generic-function 'scan_cloud-val :lambda-list '(m))
(cl:defmethod scan_cloud-val ((m <ScanDescriptor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bliss-msg:scan_cloud-val is deprecated.  Use bliss-msg:scan_cloud instead.")
  (scan_cloud m))
