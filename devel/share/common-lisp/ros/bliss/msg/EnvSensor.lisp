...
(cl:defmethod cl:initialize-instance :after ((m <EnvSensor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EnvSensor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bliss-msg:<EnvSensor> is deprecated: use bliss-msg:EnvSensor instead.")))
...
(cl:defmethod value-val ((m <EnvSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bliss-msg:value-val is deprecated.  Use bliss-msg:value instead.")
  (value m))
