...
(cl:defmethod cl:initialize-instance :after ((m <Link>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Link)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bliss-msg:<Link> is deprecated: use bliss-msg:Link instead.")))

(cl:ensure-generic-function 'fromId-val :lambda-list '(m))
(cl:defmethod fromId-val ((m <Link>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bliss-msg:fromId-val is deprecated.  Use bliss-msg:fromId instead.")
  (fromId m))

(cl:ensure-generic-function 'toId-val :lambda-list '(m))
(cl:defmethod toId-val ((m <Link>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bliss-msg:toId-val is deprecated.  Use bliss-msg:toId instead.")
  (toId m))
...
(cl:defmethod information-val ((m <Link>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bliss-msg:information-val is deprecated.  Use bliss-msg:information instead.")
  (information m))
